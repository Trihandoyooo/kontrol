...
<head>
  ...
  <link rel="stylesheet" href="templates/assets/compiled/css/app.css">
  <link rel="stylesheet" href="templates/assets/compiled/css/app-dark.css">
  <link rel="stylesheet" href="templates/assets/compiled/css/iconly.css">
</head>
...
<div class="page-heading">
 ...
 <div class="page-content">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Form Iuran</h4>
                    <p class="text-subtitle text-muted">Silahkan Bapak/Ibu anggota untuk memasukkan bukti iuran disini
                </p>
                </div>
                <div class="card-body">
                    <form action="{{ route('rapat.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <table class="table table-borderless mb-3">
                            <tr>
                                <td width="20%"><label for="jenis_rapat" class="form-label">Jenis Iuran</label></td>
                                <td>
                                    <select class="form-select" id="jenis_rapat" name="jenis_rapat" required>
                                        ...
                                        <option value="Sumbangan Fraksi">Sumbangan Fraksi</option>
                                        <option value="Dana Zakat Infaaqdan Shadaqoh (ZIS)">Dana Zakat Infaaqdan Shadaqoh (ZIS)</option>
                                        <option value="Dana Khitmat">Dana Khitmat</option>
                                        <option value="Dana Kompensasi Kepada Caleg">Dana Kompensasi Kepada Caleg</option>
                                        <option value="Dana Insidensial">Dana Insidensial</option>
                        ...
                        <table class="table table-borderless mb-3">
                            <tr>
                                <td width="20%"><label for="Dana Lainnya" class="form-label">Isi Jika Diluar Dana Yang Ada Pada Pilihan (opsional)</label></td>
                                <td>
                                    <textarea class="form-control" id="catatan" name="catatan" rows="1" placeholder="Masukkan catatan"></textarea>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table class="table table-borderless mb-3">
                            <tr>
                                <td width="20%"><label for="nominal" class="form-label">Nominal Iuran</label></td>
                                <td>
                                    <div class="input-group">
                                        <span class="input-group-text">Rp</span>
                                        <input type="text" class="form-control" id="nominal_display" placeholder="Masukkan nominal (contoh: 1000000)" required>
                        ...
                        <table class="table table-borderless mb-3">
                            <tr>
                                <td width="20%"><label for="tanggal" class="form-label">Tanggal Setor Iuran</label></td>
                                <td>
                        ...
                        <table class="table table-borderless mb-3">
                            <tr>
                                <td width="20%"><label for="dokumentasi" class="form-label">Dokumentasi</label></td>
                                <td>
                                    <div class="input-group">
                                        <input type="file" class="form-control" id="dokumentasi" name="dokumentasi" aria-describedby="dokumentasiAddon">
                                        <button class="btn btn-primary" type="button" id="dokumentasiAddon">Upload</button>
                                    </div>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table class="table table-borderless mb-3">
                            <tr>
                                <td width="20%"><label for="catatan" class="form-label">Catatan (opsional jika diperlukan)</label></td>
                                <td>
    ...
    <div class="footer clearfix mb-0 text-muted">
        ...
        <div class="float-end">
            <p>Dikembangkan Oleh <span class="text-danger"><i class="bi bi-heart-fill icon-mid"></i></span>

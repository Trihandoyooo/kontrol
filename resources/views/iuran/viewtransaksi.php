    ...
    <section class="section">
        <div class="row">
            <div class="col-12">
                ...
                <h4 class="card-title">Data Rapat</h4> <a href="/viewiuran" class="btn btn-primary float-end">Kembali</a>
                <p class="text-subtitle text-muted">Berikut merupakan bukti transaksi
                </p>
                    </div>
                    <div class="card-body">

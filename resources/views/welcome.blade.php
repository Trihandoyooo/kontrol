                    ...
                    <div class="card text-center">
                        <div class="card-body">
                            <div class="avatar avatar-2xl mb-3">
                                <img src="{{ asset('templates/assets/compiled/jpg/tes1.jpg') }}" alt="Avatar" class="rounded-circle">
                            </div>
                            <h4 class="mb-0">Pikachu</h4>
                            <small class="text-muted">Anggota DPR Bengkalis</small>
                            <p class="mt-3 text-success">Ayo kejar progressmu!</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card widget-todo">
                        <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                            <h4 class="card-title d-flex align-items-center">
                                <i class="bx bx-check font-medium-5 me-2"></i>Progress Overview
                            </h4>
                            <p class="text-subtitle text-muted">A page where users can change profile information</p>
                        </div>
                        <div class="card-body px-3 py-2">
                            <table class="table table-borderless mb-0">
                                @php
                                    $progress = [
                                        ['label' => 'Rapat dan Koordinasi', 'value' => 60, 'class' => 'info'],
                                        ['label' => 'Iuran', 'value' => 35, 'class' => 'success'],
                                        ['label' => 'Laporan Kaderisasi', 'value' => 50, 'class' => 'danger'],
                                    ];
                                @endphp

                                @foreach ($progress as $item)
                                    <tr>
                                        <td class="col-4">{{ $item['label'] }}</td>
                                        <td class="col-7">
                                            <div class="progress progress-{{ $item['class'] }} ms-2">
                                        ...
                                        <td class="col-1 text-center">{{ $item['value'] }}%</td>
                                    </tr>
                                @endforeach
                            </table>
                        </div>

        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Form Input Kaderisasi</h4>
                    <p class="text-subtitle text-muted">Silahkan Bapak/Ibu anggota untuk memasukkan bukti kegiatan kaderisasi disini
                </p>
                </div>
                <div class="card-body">
                    <form action="{{ route('rapat.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <table class="table table-borderless mb-3">
                            <tr>
                                <td width="20%"><label for="judul" class="form-label">Judul Kegiatan Kaderisasi</label></td>
                                <td>
                        ...
                        <table class="table table-borderless mb-3">
                            <tr>
                                <td width="20%"><label for="tanggal" class="form-label">Tanggal Pelaksanaan Kegiatan</label></td>
                                <td>

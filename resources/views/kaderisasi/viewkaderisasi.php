                    ...
                    <table class="table" id="table1">
                        ...
                        <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('iuran.show', $iuran['id']) }}" class="btn btn-sm btn-info">View</a>
                                        <a href="{{ route('iuran.edit', $iuran['id']) }}" class="btn btn-sm btn-warning">Edit</a>
                                        <form action="{{ route('iuran.destroy', $iuran['id']) }}" method="POST" style="display:inline;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">

    ...
    <div class="mt-4">
        <div class="card-container">
            <div class="page-heading mb-3">
                <h3>Tambah User</h3>
                <p>Lengkapi formulir berikut untuk menambahkan data user baru ke dalam sistem. Pastikan semua informasi
                ...
                <div id="user-extra-fields" style="display: none;">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="jumlah_suara_sebelumnya" class="form-control" min="0"
                                value="{{ old('jumlah_suara_sebelumnya', 0) }}">
                        </div>
                    </div>

                    <div class="mb-3">
                        <label for="jumlah_suara" class="form-label">Jumlah Suara Sekarang</label>
                        <input type="number" name="jumlah_suara" class="form-control" min="0"
                            value="{{ old('jumlah_suara', 0) }}">
                    </div>

                    <div class="mb-3">
                        <label for="jumlah_tim" class="form-label">Jumlah Tim</label>
                        <input type="number" name="jumlah_tim" class="form-control" min="0"
                            value="{{ old('jumlah_tim', 0) }}">
                    </div>

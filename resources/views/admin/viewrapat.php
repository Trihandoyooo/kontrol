...
<link rel="stylesheet" href="assets/extensions/choices.js/public/assets/styles/choices.css">
  ...
  <link rel="stylesheet" crossorigin href="templates/assets/compiled/css/app.css">
  <link rel="stylesheet" crossorigin href="templates/assets/compiled/css/app-dark.css">
</head>
                ...
                <div class="table-responsive">
                    <table class="table" id="table1">
                        ...
                        <tbody>
                                <tr>
                                    <td>Rapat Komisi</td>
                                    <td>Rapat Komisi 4</td>
                                    <td>23 Mei 2025</td>
                                    <td>
                                            <a href="{{ asset('storage/' . $rapat['dokumentasi']) }}" target="_blank" class="badge bg-info">Lihat</a>
                                       
                                            <span class="badge bg-secondary">Tidak Ada</span>
                                        
                                    </td>
                                    <td>
                                        <a href="{{ route('rapat.show', $rapat['id']) }}" class="btn btn-sm btn-info">View</a>
                                        <a href="{{ route('rapat.edit', $rapat['id']) }}" class="btn btn-sm btn-warning">Edit</a>
                                        <form action="{{ route('rapat.destroy', $rapat['id']) }}" method="POST" style="display:inline;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">

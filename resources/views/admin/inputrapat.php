        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Form Tambah Rapat</h4>
                    <p class="text-subtitle text-muted">Silahkan Bapak/Ibu anggota untuk masukkan data-data rapat disini
                </p>
                </div>
                <div class="card-body">
                    <form action="{{ route('rapat.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <table class="table table-borderless mb-3">
                            <tr>
                                <td width="20%"><label for="jenis_rapat" class="form-label">Jenis Rapat</label></td>
                                <td>
                                    <select class="form-select" id="jenis_rapat" name="jenis_rapat" required>
                                        ...
                                        <option value="Rapat Fraksi">Rapat Fraksi</option>
                                        <option value="Rapat Lintas Komisi">Rapat Lintas Komisi</option>
                                        <option value="Rapat Kelengkapan Dewan">Rapat Kelengkapan Dewan</option>
                        ...
                        <table class="table table-borderless mb-3">
                            <tr>
                                <td width="20%"><label for="judul" class="form-label">Judul Rapat</label></td>
                                <td>
                                    <input type="text" class="form-control" id="judul" name="judul" placeholder="Masukkan Judul Rapat" value=" " required>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table class="table table-borderless mb-3">
                            <tr>
                                <td width="20%"><label for="tanggal" class="form-label">Tanggal Rapat</label></td>
                                <td>
                        ...
                        <table class="table table-borderless mb-3">
                            <tr>
                                <td width="20%"><label for="peserta" class="form-label">Peserta</label></td>
                                <td>
                                    <textarea class="form-control" id="peserta" name="peserta" rows="4" placeholder="Masukkan daftar peserta" required></textarea>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table class="table table-borderless mb-3">
                            <tr>
                                <td width="20%"><label for="dokumentasi" class="form-label">Dokumentasi (opsional)</label></td>
                                <td>
                        ...
                        <table class="table table-borderless mb-3">
                            <tr>
                                <td width="20%"><label for="catatan" class="form-label">Catatan (opsional)</label></td>
                                <td>

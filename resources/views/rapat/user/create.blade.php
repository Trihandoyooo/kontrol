        ...
        <div class="col-md-12">
            ...
            <p class="text-subtitle text-muted">Berikut merupakan form yang dapat bapak/ibu isi untuk dapat menambahkan rapat.</p>
                            ...
                            <select name="jenis_rapat" class="form-select" required>
                                ...
                                <option value="rapat komisi" {{ old('jenis_rapat') == 'rapat komisi' ? 'selected' : '' }}>Rapat Komisi</option>
                                <option value="rapat paripurna" {{ old('jenis_rapat') == 'rapat paripurna' ? 'selected' : '' }}>Rapat Paripurna</option>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" name="dokumentasi[]" class="form-control" multiple id="dokumentasi-input">
                        </div>
                        ...
                        <div class="d-grid">
                            <button type="submit" class="btn btn-success btn-lg">💾 Simpan Rapat</button>
                        </div>
                    </form>
                </div>
            </div>
